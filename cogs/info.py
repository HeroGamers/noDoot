...
class info(commands.Cog, name="Information"):
    ...
    async def _botinfo(self, ctx):
        ...
        embed = discord.Embed(title="noDoot Bot Information", color=discord.Color.from_rgb(114, 137, 218),
                              timestamp=datetime.datetime.utcnow(),
                              description="The bot is currently in `%s` guilds, with a total of `%s` users!" % (
    ...
    async def _source(self, ctx):
        ...
        await ctx.send(
            "More sauce, please! Oh, you asked for the source? Well, did you know that noDoot is an Open Sourced bot, and that means that yo~ ..oh, you just wanted the link..? W-w-well here you go, you can view my code, and even write changes to it, at this GitHub repository:\n" +
